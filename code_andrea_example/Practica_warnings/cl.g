...
#define zzcr_ast(as,attr,tttype,textt) as=new AST;as->kind=(attr)->kind;as->text=(attr)->text;as->line=(attr)->line;as->right=NULL;as->down=NULL;as->sc=0;as->tp=create_type("error",0,0);as->ref=0;as->hay_valor=0;
...
constr_type: INT | STRUCT^ (field)* ENDSTRUCT! | BOOL | ARRAY^ OPENBRA! INTCONST CLOSEBRA! OF! constr_type;
...
//Expressions segons prioritats d'operacions
