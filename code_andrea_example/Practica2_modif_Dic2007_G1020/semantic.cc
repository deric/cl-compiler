...
void errorintrequired(int l, string s) {
  TypeError = 1;
  cout<<"L. "<<l<<": Int type requiered in "<<s<<"."<<endl;
}
/************************************************************************************************************************************************/
/************************************************************************************************************************************************/
...
/** CONSTANT BOOLEANA **/
	...
	TypeCheck (a->down, "expression");	// Comprovem l'expressió
      if (a->down->tp->kind != "int")		//La condicio ha de ser booleana
	{
	  errorintrequired (a->line, a->kind);
	}

      TypeCheck (a->down->right, info);		// Comprovem la llista de cases
      ...
      if (a->down->tp->kind != "int")		//La condicio ha de ser booleana
	{
      ...
      TypeCheck (a->down, info);		// Comprovem la llista d'instruccions
  } else {
