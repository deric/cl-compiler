...
constr_type: INT | STRUCT^ (field)* ENDSTRUCT! | BOOL | ARRAY^ OPENBRA! INTCONST CLOSEBRA! OF! constr_type | STRING;
...
instruction:
	...
	|WRITE^ OPENPAR! ( expression) CLOSEPAR!
	|WRITELN^ OPENPAR! ( expression) CLOSEPAR!;
...
expsimple:
	...
	|SUBSTR^ OPENPAR! ( expression COMMA! expression (COMMA! expression |)) CLOSEPAR!
	|INTCONST
	|STRINGCONST
	|TRUe
	|FALSe
